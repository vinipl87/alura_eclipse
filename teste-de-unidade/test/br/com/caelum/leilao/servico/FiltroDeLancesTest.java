...
public class FiltroDeLancesTest {
	...
	public void deveSelecionarLancesMaioresQue5000() {
		Usuario joao = new Usuario("Joao");
		FiltroDeLances filtro = new FiltroDeLances();
		List<Lance> resultado = filtro.filtra(Arrays.asList(new Lance(joao, 4000), new Lance(joao, 6000),
				new Lance(joao, 7000), new Lance(joao, 1000), new Lance(joao, 5000)));
	...
	public void deveEliminarEntre700E1000() {
		...
		FiltroDeLances filtro = new FiltroDeLances();
		List<Lance> resultado = filtro.filtra(
				Arrays.asList(new Lance(joao, 800), new Lance(joao, 1000), new Lance(joao, 700), new Lance(joao, 900)));
